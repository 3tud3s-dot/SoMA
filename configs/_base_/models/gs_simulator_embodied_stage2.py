...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=[
            ...
            dict(type='MSELoss', reduction='sum', loss_weight=1.0, loss_name='loss_mse_skeleton'),
            ],
        accuracy=[
            dict(type='L2Accuracy', reduction='mean', acc_name='acc_l2_render'),
            dict(type='L1Accuracy', reduction='mean', acc_name='acc_l1_render'),
            dict(type='SSIMAccuracy', reduction='mean', acc_name='acc_ssim_render'),
            dict(type='PSNRAccuracy', reduction='mean', acc_name='acc_psnr_render'),
            ],
        ),
    gs_scene=[
