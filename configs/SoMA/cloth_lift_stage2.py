...
_base_ = [
    '../_base_/models/gs_simulator_embodied_stage2.py',
...
step_initial = 3 - step_increase_magnitude * epoch_stage1    # initial sequence length
...
train_split = [[i, min(i+frame_gap+extra_frame_stage2, 150)] for i in range(0, 150, frame_gap)]
test_split  = [[0, 150]]
# Cluster Parameters
...
for scene_name in scene_list:
    ...
    split_list['train'][scene_name] = train_split
    split_list['test'][scene_name] = test_split
...
model = dict(
    ...
    flag_save_gaussian=flag_save_gaussian,
    flag_update_gaussian=flag_update_gaussian,
    flag_update_gaussian_train=flag_update_gaussian_train,
    data_dir=data_dir,
    dt=dt,
